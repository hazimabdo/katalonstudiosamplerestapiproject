...
response1 = WS.sendRequest(findTestObject('rest web services/list users'))
...
//WS.sendRequestAndVerify(findTestObject('rest web services/update user'))

WS.sendRequest(findTestObject('rest web services/update user',
	[('username') : value]))
